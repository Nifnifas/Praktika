...
function renderForm($regnr, $data, $pav, $byl_link, $Pastabos, $error)
...
renderForm($regnr, $data, $pavad, $byl_link, $Pastabos, $error);
...
mysql_query("INSERT ".$DB_table." SET RegNr='$regnr', Data='$data', Pastabos='$Pastabos', Pavadinimas='$pavad', Bylos_nuoroda='$byl_link', Vartotojas='$vartotojas'")
