...
<body bgcolor="#f2f2f2">
    ...
    <table id="header1">
        <tr>
            <th><span style="float:center;">Jūs peržiūrite registro '<?= $name ?>' įrašą <?= $id ?></span>
            <th></th>
            <th></th>
            </th>
        </tr>
    ...
    <table id="irasas">
        <div>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="<?=$i?>" id="s<?php echo $i;?>"
                        value="<?php echo $info[$i]["description"][0]; ?>" class="s" readonly /><br />
                </td>
            </tr>
            <?php
                                            break;
            ...
            <tr>
                ...
                <td>
                    <textarea rows="5" cols="40" name="<?= $i ?>" class="form-control"
                        readonly><?=$info[$i]["description"][0]?></textarea>
                </td>
            </tr>
            <?php
                                        }
